...
public class BankStatement {
    //retreive list of transactions within a date range
    //generate a pdf
    //send pdf via email
    ...
    private static final String FILE="/Users/rahulroshan/Downloads/demo-bank/src/main/resources/statement.pdf";
    ...
    public List<Transaction> generateStatement(String accountNumber,String startDate, String endDate) throws DocumentException, FileNotFoundException {
        ...
        PdfPTable bankbankInfoTable= new PdfPTable(1);
        PdfPCell bankName= new PdfPCell(new Phrase("Demo Bank"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.BLUE);
        bankName.setPadding(20f);

        PdfPCell bankAddress=new PdfPCell(new Phrase("AA 00 BB 123"));
        bankAddress.setBorder(0);
        bankbankInfoTable.addCell(bankName);
        bankbankInfoTable.addCell(bankAddress);

        PdfPTable statementInfo=new PdfPTable(2);
        PdfPCell customerInfo= new PdfPCell(new Phrase("Start Date: "+ startDate));
        customerInfo.setBorder(0);
        PdfPCell statement= new PdfPCell(new Phrase("STATEMENT OF ACOUNT"));
        ...
        document.add(bankbankInfoTable);
